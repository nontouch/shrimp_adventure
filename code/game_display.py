...
class built() :
    def __init__(self,background,ground_play,player) :
        ...
        for i in player :
            ...
            charactor_movement.append([i[0],i[3],i[4],i[5]])
        ...
        while is_running:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key==K_UP:
                        ...
                        keys[1]=True
                        charactor[0][0]  = charactor_movement[0][3]
                    elif event.key==K_DOWN:
                        keys[2]=True
                    elif event.key==K_RIGHT:
                        keys[3]=True
                        charactor[0][0] = charactor_movement[0][1]
                ...
                if event.type == pygame.KEYUP:
                    if event.key==pygame.K_UP:
                        ...
                        keys[1]=False
                        charactor[0][0]  = charactor_movement[0][2]
                    elif event.key==pygame.K_DOWN:
                        keys[2]=False
                    elif event.key==pygame.K_RIGHT:
                        keys[3]=False
                        charactor[0][0]  = charactor_movement[0][0]
            ...
            if (charactor[0][1].point_y) - (height-164) < 0 :
    ...
    # If the right key is pressed
                    ...
                    if charactor[0][1].point_x <wide-64: # If the player is inside the playing field
    ...
    # If the down key is pressed
                    ...
                    if charactor[0][1].point_y < height-164: # If the coordinate is less than the height of the playing field
